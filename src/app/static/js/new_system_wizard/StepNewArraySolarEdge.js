...
class StepNewArraySolarEdge extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    const shouldAvoid = this.props.currentStep !== "newarray" || this.props.inverterBrand !== "SolarEdge";
        ...
        }
        {
          ...
          <div>
            ...
            {this.props.arrays[this.props.arrayIndex]['inverter_indexes'] != null &&
              <label>In inverter {this.props.arrays[this.props.arrayIndex]['inverter_indexes'].map(x => x + 1).join(', ')}</label>
            }
            {this.props.inverters[this.props.inverterIndex]['assigned_arrays'].indexOf(this.props.arrayIndex) === -1 &&
              <button type="button" onClick={() => { this.props.addToInverter() }}>Add to inverter {this.props.inverterIndex + 1}</button>
            }
            {this.props.inverters[this.props.inverterIndex]['assigned_arrays'].indexOf(this.props.arrayIndex) > -1 &&
              <button type="button" onClick={() => { this.props.removeFromInverter() }}>Remove from inverter {this.props.inverterIndex + 1}</button>
            }
