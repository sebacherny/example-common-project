"""
Django settings for solar system project.
...
# Mail sender info
MAIL_SENDER_USER = os.environ['MAIL_SENDER_USER']
MAIL_SENDER_PASSWORD = os.environ['MAIL_SENDER_PASSWORD']
...
ENPHASE_USERNAME = os.environ['ENPHASE_USERNAME']
ENPHASE_PASSWORD = os.environ['ENPHASE_PASSWORD']
ENPHASE_KEY = os.environ['ENPHASE_KEY']

# For testing
SEND_MAIL_NEW_USER = False
URL_PREFIX_FOR_LINK = os.environ['URL_PREFIX_FOR_LINK']
