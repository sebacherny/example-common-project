...
USER_REGISTRATION_VALIDATION = os.environ.get('USER_REGISTRATION_VALIDATION', True)

# NEEDED DATASETS
MASTER_CSR_DATASET_NAME = 'Master CSR Spending Dataset'
ROWS_PENDING_VALIDATION_DATASET_NAME = 'Data Pending Admin Validation'

# US STATES
ALL_STATES = ['AL', 'AK', 'AZ', 'AR', 'CA', 'CO', 'CT',
